...
//I am using this class to get GPS permission from user
...
import static uk.ac.tees.a0321466.globalVariables.REQUEST_CODE;
class mapPermission extends AppCompatActivity {
    private Context contextActivity;
    //MapsActivity.OnCustomEventListener _mp;
    OnCustomCallback _callback; //gps callback when gps enable done

    public mapPermission(Context cActivity) {
        contextActivity=cActivity;
        _callback = (OnCustomCallback) contextActivity; //invoke ....
        //_mp=mp;
...
//            _mp.onEvent();
            _callback.gpsEnableDone(); //this call a method, which is defined in MapsActivity
